...
namespace Service_017_RaykaAgustasya
{
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_20180140017_RaykaAgustasya.ContractType".
    [DataContract]
